...
describe("E2E tests for customer", () => {
  ...
  it("should update a customer", async () => {
    ...
    expect(response2.status).toBe(200);
    expect(response2.body.name).toBe("John Updated");
    expect(response2.body.address.street).toBe("Street Updated");
    expect(response2.body.address.city).toBe("City Updated");
    expect(response2.body.address.number).toBe(1234);
    expect(response2.body.address.zip).toBe("12344");
  });
});
